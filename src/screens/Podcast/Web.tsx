...
export default function index() {
	const data = [
		{ id: 1, title: 'Item 1', icon: 'Podcast' },
		{ id: 2, title: 'Item 2', icon: 'Podcast' },
		{ id: 3, title: 'Item 3', icon: 'Podcast' },
		{ id: 4, title: 'Item 4', icon: 'Podcast' },
		{ id: 5, title: 'Item 5', icon: 'Podcast' },
		{ id: 6, title: 'Item 6', icon: 'Podcast' },
		{ id: 7, title: 'Item 7', icon: 'Podcast' },
		{ id: 8, title: 'Item 8', icon: 'Podcast' },
		{ id: 9, title: 'Item 9', icon: 'Podcast' },
		{ id: 10, title: 'Item 10', icon: 'Podcast' },
		{ id: 11, title: 'Item 11', icon: 'Podcast' },
		{ id: 12, title: 'Item 12', icon: 'Podcast' },
	  ];
	return (
