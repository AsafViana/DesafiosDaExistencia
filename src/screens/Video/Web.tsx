...
export default function index() {
	const data = [
		{ id: 1, title: 'Item 1', icon: 'Video' },
		{ id: 2, title: 'Item 2', icon: 'Video' },
		{ id: 3, title: 'Item 3', icon: 'Video' },
		{ id: 4, title: 'Item 4', icon: 'Video' },
		{ id: 5, title: 'Item 5', icon: 'Video' },
		{ id: 6, title: 'Item 6', icon: 'Video' },
		{ id: 7, title: 'Item 7', icon: 'Video' },
		{ id: 8, title: 'Item 8', icon: 'Video' },
		{ id: 9, title: 'Item 9', icon: 'Video' },
		{ id: 10, title: 'Item 10', icon: 'Video' },
		{ id: 11, title: 'Item 11', icon: 'Video' },
