...
export default function index() {
	const data = [
		...
		{ id: 2, title: 'Item 2', icon: 'Artigo' },
		{ id: 3, title: 'Item 3', icon: 'Artigo' },
		{ id: 4, title: 'Item 4', icon: 'Artigo' },
		{ id: 5, title: 'Item 5', icon: 'Artigo' },
		{ id: 6, title: 'Item 6', icon: 'Artigo' },
		{ id: 7, title: 'Item 7', icon: 'Artigo' },
		{ id: 8, title: 'Item 8', icon: 'Artigo' },
		{ id: 9, title: 'Item 9', icon: 'Artigo' },
		{ id: 10, title: 'Item 10', icon: 'Artigo' },
		{ id: 11, title: 'Item 11', icon: 'Artigo' },
		{ id: 12, title: 'Item 12', icon: 'Artigo' },
	  ];
	return (
